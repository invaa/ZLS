package com.ziplocator.service.util;
...
/**
 * Getting names for country and state codes.
 *
 *
 */
public final class StateCodeManager {
    ...
    public static String getStateName(final String stateCode) {
        ...
        for (String countryCode : locales) {
            ...
            if (obj.getCountry().equals(stateCode)) {
                result = obj.getDisplayCountry(Locale.ENGLISH);
            }
        }

        if (result.equals("")) {
            result = STATE_MAP.get(stateCode);
        }
        if (result == null) {
            result = "";
        }
